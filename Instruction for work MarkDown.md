...
Также если в начале поставить два знака пробел, а затем (*),(-) или цифру с точкой то можно делать подразделы с большим отступом.
...
Для создания отступа нужно после цифры и точки поставить пробел.Также если в начале поставить два знака пробел, а затем (*),(-) или цифру с точкой то можно делать подразделы с большим отступом.
